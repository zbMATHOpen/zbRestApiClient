...
class ContributionType(object):
    ...
    """
    ABSTRACT = "abstract"
    FROM_THE_TEXT = "from_the_text"
    EDITORIAL_REMARK = "editorial_remark"
    PUBLISHERS_DESCRIPTION = "publishers_description"
    REVIEW = "review"
    SUMMARY = "summary"
    SCAN = "scan"
    """
    ...
    def __init__(self):  # noqa: E501
        """ContributionType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContributionType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContributionType):
            return False
